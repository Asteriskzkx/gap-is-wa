      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center bg-green-50 relative">
        <div className="p-12 w-full">
          ...
          <div className="absolute bottom-10 left-10 bg-white/80 p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold text-green-800">ระบบรับรองมาตรฐาน GAP</h3>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-green-800 mb-2">เข้าสู่ระบบ</h1>
            <p className="text-gray-600">ระบบรับรองมาตรฐานสวนยาง GAP</p>
          </div>
