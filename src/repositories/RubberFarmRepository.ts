...
export class RubberFarmRepository extends BaseRepository<RubberFarmModel> {
    ...
    async update(id: number, data: Partial<RubberFarmModel>): Promise<RubberFarmModel | null> {
        try {
    ...
    private mapToModel(prismaRubberFarm: PrismaRubberFarm & { plantingDetails?: any[] }): RubberFarmModel {
        return new RubberFarmModel(
            prismaRubberFarm.rubberFarmId,
            prismaRubberFarm.farmerId,
            prismaRubberFarm.villageName,
            prismaRubberFarm.moo,
            prismaRubberFarm.road,
            prismaRubberFarm.alley,
            prismaRubberFarm.subDistrict,
            prismaRubberFarm.district,
            prismaRubberFarm.province,
            prismaRubberFarm.location,
            prismaRubberFarm.plantingDetails || [],
            prismaRubberFarm.createdAt,
            prismaRubberFarm.updatedAt
        );
    }
}