...
| รหัสกรณีทดสอบ | ชื่อกรณีการทดสอบ        | ขั้นตอนการทดสอบ                                                                                    | ข้อมูลการทดสอบ                                 | ค่าคาดหวัง                              |
| ------------- | ----------------------- | -------------------------------------------------------------------------------------------------- | ---------------------------------------------- | --------------------------------------- |
| TC-013        | เปิดไฟล์สำเร็จ (มี URL) | 1) ในแถวหนึ่ง คลิกปุ่มไอคอนดูไฟล์ (pi-eye) 2) mock `/api/v1/files/get-files` ให้คืน `files[0].url` | files[0].url = https://example.com/...pdf      | เปิดแท็บ/หน้าต่างใหม่ไปยัง URL นั้น     |
