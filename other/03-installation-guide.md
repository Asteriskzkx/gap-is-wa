# วิธีการติดตั้งระบบและการตั้งค่าพื้นฐานหลังการติดตั้ง

ในบทนี้จะอธิบายขั้นตอนการติดตั้งระบบและการตั้งค่าพื้นฐานที่จำเป็นสำหรับการเริ่มต้นใช้งานระบบสารสนเทศสำหรับการจัดการข้อมูลทางการเกษตรผลผลิตยางพาราตามมาตรฐานจีเอพี

## 2.1 ความต้องการเบื้องต้น (Prerequisites)
...
## 2.2 ขั้นตอนการติดตั้งระบบ

### 2.2.1 Clone ซอร์สโค้ดจาก GitHub Repository
...
### 2.2.2 การตั้งค่าไฟล์ Environment Variables (.env)
...
เมื่อตั้งค่าเรียบร้อยแล้ว ให้บันทึกค่า
...
### 2.2.3 การสร้าง SSL Certificate
...
### 2.2.4 การตั้งค่าเพื่อเริ่มใช้งานบน Docker
...
**หมายเหตุ:** กรณีเกิดข้อผิดพลาดดังข้อความต่อไปนี้ "permission denied while trying to connect to the Docker daemon socket at unix:///var/run/docker.sock" ให้เติม `sudo` หน้าคำสั่ง

```bash
sudo docker compose -f docker-compose.yml up -d
```

### 2.2.5 การตั้งค่า Nginx
...
server {
    listen 80;
    server_name your-domain.com;  # เปลี่ยนจาก localhost เป็น Domain ที่ต้องการ
...
## 2.3 การตั้งค่าพื้นฐานหลังการติดตั้ง

### 2.3.1 การเข้าถึงแอปพลิเคชัน
...
### 2.3.3 การเข้าถึงฐานข้อมูล PostgreSQL
