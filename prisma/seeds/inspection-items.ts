...
export async function seedInspectionItems(prisma: PrismaClient) {
  ...
  const itemsType1 = [
    ...
    { id: 3, typeId: 1, itemNo: 3, name: "วัตถุอันตรายทางการเกษตร" },
    {
      ...
      typeId: 1,
      itemNo: 4,
      name: "การจัดการคุณภาพในกระบวนการผลิตก่อนการเปิดกรีด",
    },
  ...
  const itemsType2 = [
    ...
    { id: 9, typeId: 2, itemNo: 3, name: "วัตถุอันตรายทางการเกษตร" },
    {
      ...
      typeId: 2,
      itemNo: 4,
      name: "การจัดการคุณภาพในกระบวนการผลิตหลังการเปิดกรีด",
    },
    {
      id: 11,
      typeId: 2,
      itemNo: 5,
      name: "การเก็บเกี่ยวและการปฏิบัติหลังการเก็บเกี่ยว สำหรับผลิตน้ำยางสด",
    },
    {
      id: 12,
      typeId: 2,
      itemNo: 6,
      name: "การผลิตวัตถุดิบคุณภาพดีและการขนส่งสำหรับผลิตน้ำยางสด",
    },
  ...
  const itemsType3 = [
    ...
    },
    {
      ...
      typeId: 3,
      itemNo: 5,
      name: "การเก็บเกี่ยวและการปฏิบัติหลังการเก็บเกี่ยว สำหรับผลิตยางก้อนถ้วย",
    },
    {
      id: 20,
      typeId: 3,
      itemNo: 6,
      name: "การผลิตวัตถุดิบคุณภาพดีและการขนส่งสำหรับผลิตยางก้อนถ้วย",
    },
