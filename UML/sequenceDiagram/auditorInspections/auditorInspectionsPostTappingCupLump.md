# Auditor Inspections - Post-Tapping Cup Lump (ตรวจประเมินสวนยางพาราหลังเปิดกรีดและการผลิตยางก้อนถ้วย) - Sequence Diagram (High-Level)
...
sequenceDiagram
    ...
    Auditor->>Page: Select inspection (type: ยางก้อนถ้วย, status: รอการตรวจประเมิน)
    ...
    Controller-->>Page: InspectionItems data (8 items for cup lump type)
...
2. **Select Inspection & Load Items** - เลือกการตรวจประเภท "ยางก้อนถ้วย" ที่มีสถานะ "รอการตรวจประเมิน" และโหลดรายการตรวจ
