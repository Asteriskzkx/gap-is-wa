# Auditor Inspections - Pre-Tapping (ตรวจประเมินสวนยางพาราก่อนเปิดกรีด) - Sequence Diagram (High-Level)
...
sequenceDiagram
    ...
    Auditor->>Page: Select inspection (type: ก่อนเปิดกรีด, status: รอการตรวจประเมิน)
    ...
    Controller-->>Page: InspectionItems data (6 items for pre-tapping)
    ...
    loop For each Inspection Item (1-6)
...
2. **Select Inspection & Load Items** - เลือกการตรวจที่มีสถานะ "รอการตรวจประเมิน" และโหลดรายการตรวจทั้ง 8 รายการ
...
- Progress indicator อัพเดทเป็น "รายการ X/6"
- เมื่อครบ 8 รายการ แสดงปุ่ม "บันทึกและสรุปผลการตรวจ"
...
- `inspectionItems` - Array of 8 inspection items with requirements
