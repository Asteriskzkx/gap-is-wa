...
<table border="1" cellspacing="0" cellpadding="6">
  <tr>
    <td><b>ชื่อคลาส:</b> CertificateModel</td>
    <td><b>รหัส:</b> 61</td>
    <td><b>ประเภท:</b> Domain, Concrete</td>
  </tr>
  <tr>
    <td colspan="2"><b>คำอธิบาย:</b> คลาสที่แทนข้อมูล Certificate โดยเป็นคลาสในการสร้างออบเจ็กต์ข้อมูล</td>
  ...
  <tr>
    <td valign="top"><ul>
  <li>certificateId (number)</li>
  <li>inspectionId (number)</li>
  <li>effectiveDate (Date)</li>
</ul></td>
    <td valign="top"><ul>
  <li>expiryDate (Date)</li>
  <li>cancelRequestFlag (boolean)</li>
  <li>activeFlag (boolean)</li>
</ul></td>
  </tr>
</table>
    </td>
  ...
  <li>Composition (Has-a): มีองค์ประกอบเป็น CommitteeModel (committeeCertificates)</li>
</ul>
    </td>
  </tr>
</table>
