...
<table border="1" cellspacing="0" cellpadding="6">
  <tr>
    <td><b>ชื่อคลาส:</b> AuditorReportService</td>
    <td><b>รหัส:</b> 74</td>
    <td><b>ประเภท:</b> Concrete</td>
  </tr>
  <tr>
    <td colspan="2"><b>คำอธิบาย:</b> คลาสสำหรับสร้างรายงาน/สรุปข้อมูลตามเงื่อนไขที่กำหนด</td>
    <td><b>ยูสเคสที่เกี่ยวข้อง:</b> </td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><b>หน้าที่ความรับผิดชอบ</b>
      <ul>
  <li>ดึงข้อมูล AuditorReport / My Inspection Report (`getMyInspectionReport`)</li>
</ul>
    </td>
