...
<table border="1" cellspacing="0" cellpadding="6">
  <tr>
    <td><b>ชื่อคลาส:</b> RequirementService</td>
    <td><b>รหัส:</b> 48</td>
    <td><b>ประเภท:</b> Concrete</td>
  </tr>
  <tr>
    <td colspan="2"><b>คำอธิบาย:</b> คลาสที่ดำเนินการทางตรรกะทางธุรกิจกับข้อมูล Requirement และประสานงานกับรีโพซิทอรี/บริการที่เกี่ยวข้อง</td>
  ...
  <li>อัปเดต Requirement / Requirement Evaluation (`updateRequirementEvaluation`)</li>
  <li>ลบ Requirement / Requirement (`deleteRequirement`)</li>
</ul>
    </td>
  ...
  <tr>
    <td colspan="3" valign="top"><b>ความสัมพันธ์:</b>
      <ul>
  <li>Generalization (a-kind-of): สืบทอด BaseService~RequirementModel~</li>
  <li>Association: ใช้งาน AuditLogService</li>
  <li>Association: ใช้งาน RequirementRepository</li>
  <li>Association: ถูกใช้งานโดย RequirementController</li>
</ul>
    </td>
  </tr>
</table>
